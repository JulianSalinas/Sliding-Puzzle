...
object Programa extends App{
  ...
  //Probando los metodos de los estados
  val estado_0 = new Estado( List(1,2,3,4,5,6,7,8,0) )
  println("Estado riginal: \n" + estado_0)
  println("GetPosicion(6): " + estado_0.GetPosicion(6))
  println("GetElemento(1,1): " + estado_0.GetElemento(1, 1))
  println("SetElemento(0,0,50): \n" + estado_0.SetElemento(0, 0, 50))
  println("CambiarPosiciones(0,6): \n" + estado_0.CambiarPosiciones(0, 6))
  println("CambiarPosiciones((0,0),(0,1)): \n" + estado_0.CambiarPosiciones((0,0),(0, 1)))
  ...
  val matriz1 = new Estado(List(2,8,7,4,5,6,3,0,1))
  val matrizMeta = new Estado(List(1,2,3,4,5,6,7,8,0))
